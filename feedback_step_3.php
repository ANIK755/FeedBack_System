...
<div id="table"> 
    <div class="tr">
        ...
        <div class="td">
			<input type="text" disabled size="5" value="<?php echo $_SESSION['roll'];?>" />    <!--visible-->
            <input type="hidden" value="<?php echo $_SESSION['roll'];?>" name="roll" />       <!--hidden backend-->
        </div>
    </div>
     <div class="tr">
     <div class="td">
     ...
     <div class="td">
			...
			while($y=mysqli_fetch_array($x))                                //fetch and displays dropdown of subjets
			{
			 ?>
