...
session_start();
if(!isset($_SESSION['aid']))             //is an associative array It is used to set and get session variable values
{
	header("location:index.php");
}
$aid=$_SESSION['aid'];
$x=mysqli_query($al,"select * from admin where aid='$aid'");       //authenticate
...
<div id="table"> 
    <div class="tr">
        ...
        <div class="td">
            ...
            <?php
			$x=mysqli_query($al,"select * from faculty");     //selects all faculty from database
     ...
     <div class="td">
			...
			{
			 ?>
             <option value="<?php echo $y['s1'];?>"><?php echo $y['s1'];?></option>    <!--value is in backend-->
